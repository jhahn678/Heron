...
router.post("/link/google", authenticateRequest, authControllers.linkGoogleAccount)
router.post("/link/facebook", authenticateRequest, authControllers.linkFacebookAccount)
router.post("/link/apple", authenticateRequest, authControllers.linkAppleAccount)
...
router.post('/change-email', authenticateRequest, authControllers.changeEmail)
